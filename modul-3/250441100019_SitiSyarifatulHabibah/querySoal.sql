SELECT nama_barang, kategori, kode_sku, status_qc, lokasi_rak, stok FROM inventaris_gudang_pusat WHERE lokasi_rak IS NULL AND stok > 0 AND status_qc = 'Lulus';


SELECT DISTINCT kategori, kode_sku, harga_satuan FROM inventaris_gudang_pusat WHERE kode_sku LIKE '%ELEC%X' AND harga_satuan > 5000000;
